...
const vcard = 'BEGIN:VCARD\n' //jangan ganti eror jngn nyesel
            ...
            + 'FN:RiyanBOTZ\n' //ganti aja 
            + 'ORG: Bumer Bot;\n' //ganti aja
            + 'TEL;type=CELL;type=VOICE;waid=62887437010015:+62887437010015\n'  //ganti nomor lu
...
namabot = ' JouganBot'
cr = '*「 JouganBot 」*' //ganti nama bot
status = "Global Bot Whatsapp" 
lolkey = '075f40883ef4bce515d092bf' //apikey nya beli sendiri
Xteam = '7ba65de0de0c0088' // apikey
apivhtear = '291002juan' //apikey beli sendiri
ZeksApi = 'apivinz' // isi apikey 
onlydev = '682aeab645ed61cf137cf971' // isi apikey
/******** OWNER NUMBER**********/

const ownerNumber = ["62887437010015@s.whatsapp.net"]   //ganti nomor lu
//###########
const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
if(time2 < "23:59:00"){
var ucapanWaktu = 'Selamat Malam Subreker ku'
                                        }
if(time2 < "19:00:00"){
var ucapanWaktu = 'Selamat Petang Subreker ku'
                                         }
if(time2 < "18:00:00"){
var ucapanWaktu = 'Selamat Sore Subreker ku'
                                         }
if(time2 < "15:00:00"){
var ucapanWaktu = 'Selamat Siang Subreker ku'
                                         }
if(time2 < "11:00:00"){
var ucapanWaktu = 'Selamat Pagi Subreker ku'
                                         }
if(time2 < "05:00:00"){
var ucapanWaktu = 'Selamat Malam Subreker ku'
                                         }
...
console.log(color('WELCOME DI WA CONNECTION JOUGAN, SILAHKAN SCAN KODE DI BAWAH','green'))
...
- *Pesan :* ${body ? body : '-'}\`\`\``
	...
	client.on('message-new', async (mek) => {
		...
		try {
            ...
            //-
            const freply = { key: { fromMe: false, participant: `62887437010015@s.whatsapp.net`, ...(from ? { remoteJid: "6283136505591-1614953337@g.us" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/png", "caption": `${YahahaHayyuk}`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./lib/logo.jpeg')} } }
			const fkontak = { key: { fromMe: false, participant: `62887437010015@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${YahahaHayyuk}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${YahahaHayyuk},;;;\nFN:${YahahaHayyuk},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail": fs.readFileSync('./lib/logo.jpeg')}}}
			const ftoko = { key: { fromMe: false, participant: `62887437010015@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./src/logobot.jpg') }, "title": `Subrek ItsAra`, "productImageCount": 9999 }, "businessOwnerJid": `62887437010015@s.whatsapp.net`}}}
...
//=============== BATES COK ===================//
		...
		case 'menu':
            ...
            over = fs.readFileSync(`./welkam/over.mp3`)
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				try {
				ppintg = await client.getProfilePicture(`${sender.split('@')[0]}@c.us`)
				} catch {
				ppintg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
				}
                      lzain = `
╭─「 ${namabot} 」
│
...
│• Prefix : ${prefix}
│
│• Instagram : @itsmealwi_
│• FaceBook : Facebook.com
│• github : Otw
│• Nomor Owner : wa.me/62887437010015
╰────
...
╭─「 Join Group 」
│• https://chat.whatsapp.com/DbIKMsIn5qb8m2dHXq7tFd
╰────
...
╭──❲ UP REASON ❳
│• ADD FITUR/TAMBAHAN FITUR BANYAK
│• Team Creator Bot
╰────────────────⊱
...
╰────────────────⊱
`
client.sendMessage(from, ppintg, image, {caption: lzain})
break
		...
		case 'lpr':
					...
					client.sendMessage('62887437010015@s.whatsapp.net', options, text, {quoted: mek})
...
if (args.length == 0) return reply(`Idnya mana kak?`)
		...
		case 'leave':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					...
					setTimeout( () => {
					client.updatePresence(from, Presence.composing) 
					client.sendMessage(from, 'Siap Tuan, Bye Penghuni Grup🗣', text) // ur cods
					}, 0)
					break
		case 'bc': 
					if (!isOwner) return reply(ind.ownerb()) 
